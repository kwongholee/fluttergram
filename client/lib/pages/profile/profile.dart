...
class Profile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("${context.watch<userProvider>().id}'s Profile Page"), actions: [IconButton(onPressed: () {Navigator.pushNamed(context, "/profile/settings");}, icon: Icon(Icons.settings))]),
