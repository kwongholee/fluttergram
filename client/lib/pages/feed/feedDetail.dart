    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            FeedHeader(writer: context.watch<UserFeedListProvider>().feedList[widget.id]["writer"], num: widget.id),
            ...
            Text("좋아요: ${context.watch<UserFeedListProvider>().feedList[widget.id]["like"]}"),
            Text("${context.watch<UserFeedListProvider>().feedList[widget.id]["introduce"]}")
          ],
          )
      ),
    );
